 ...
 * SecurityConfig
 * <p>
 * SecurityConfig class from <a href="https://github.com/danvega/jwt/blob/master/src/main/java/dev/danvega/jwt/Application.java">this link</a>
 * <p>
 * @author danvega
 * @since 10/2/24
 */
...
public class SecurityConfig {
    ...
    public InMemoryUserDetailsManager users() {
        return new InMemoryUserDetailsManager(
                User.withUsername("read-user").password("{noop}password1").authorities("read").build()
                , User.withUsername("write-user").password("{noop}password2").authorities("write").build());
    }
